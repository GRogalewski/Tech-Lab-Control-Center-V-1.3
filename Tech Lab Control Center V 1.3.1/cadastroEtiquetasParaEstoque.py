...
class EtiquetaSimplificadaApp(ctk.CTk):
    ...
    def criar_aba_gerenciar(self):
        ...
        self.estagio_combo = ctk.CTkComboBox(estagio_frame, values=["Formatação", "Validação", "Limpeza", "Acionado garantia"], variable=self.estagio_triagem_var, width=180)
        ...
        self.tags_triagem_text.pack(fill="both", expand=True, padx=15, pady=(0, 15))
    ...
    def _thread_executar_triagem(self, lista_tags, cookie, estagio_escolhido):
        ...
        for idx, tag in enumerate(lista_tags):
            ...
            try:
                ...
                # 🟢 MONTAGEM DINÂMICA DO PACOTE DE DADOS
                # 🟢 MONTAGEM DINÂMICA DO PACOTE DE DADOS
                if estagio_escolhido == "Acionado garantia":
                    novo_status = "300" # Valor confirmado (Waiting for Supplier)
                    ...
                    dados_triagem = {
                        ...
                        "correlation_id": "N/A" # 🟢 A chave secreta que destranca o bloqueio!
                    }
                else:
                    novo_status = "2" # Work in Progress
                ...
                if resp_atualizar.status_code == 200:
                    ...
                    # Se der erro, ele printa no terminal de fundo para a gente ver o que o ServiceNow respondeu
                    print(f"Erro no ServiceNow: {resp_atualizar.text}")
    ...
    def criar_aba_individual(self):
        ...
        ctk.CTkRadioButton(estado_buttons_frame, text="Empréstimo", variable=self.estado_var, value="Empréstimo").pack(anchor="w", pady=2)
